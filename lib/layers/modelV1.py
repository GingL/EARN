...
class KARN(nn.Module):
    ...
    def forward(self, pool5, fc7, lfeats, dif_lfeats, cxt_fc7, cxt_lfeats, dist, labels, enc_labels, dec_labels,
        ...
        # object feats
        rel_feats, dist, max_rel_id = self.rel_encoder(cxt_fc7, cxt_lfeats, obj_attn, wo_obj_idx,
        ...
        return total_ann_score, loss, sub_idx, max_rel_id, sub_attn, obj_attn, weights, sub_attn_lan, loc_attn_lan, rel_attn_lan, sub_ann_attn, loc_ann_attn, rel_ann_attn
