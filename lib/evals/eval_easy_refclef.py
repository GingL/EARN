...
def eval_split(loader, model, split, opt):
    ...
    while True:
        ...
        tic = time.time()
        scores, loss, sub_idx = model(Feats['pool5'], Feats['fc7'], Feats['lfeats'],  Feats['cxt_fc7'],
                             Feats['cxt_lfeats'], Feats['dist'], labels, enc_labels, dec_labels, sim['sub_sim'],
                                                  sim['obj_sim'],sim['sub_emb'], sim['obj_emb'], att_labels,
        ...
        pred_box = loader.Sents[sent_ids]['bbx'][pred_ix]
