...
def parse_opt():
    ...
    # Data input settings
    parser.add_argument('--dataset', type=str, default='refclef', help='name of dataset')
    ...
    parser.add_argument('--sub_filter_thr', default=0.6, type=float, help='subject filter threshold')
    ...
    parser.add_argument('--batch_size', type=int, default=1, help='batch size in number of images per batch')
    ...
    parser.add_argument('--exp_id', type=str, default='exp0', help='experiment id')
